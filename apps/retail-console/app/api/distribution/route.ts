...
// FoundRetail's real distribution/fulfillment view — every shipment this brand has ever booked
...
export async function GET(request: NextRequest) {
  ...
  const shipments = await listShipmentsForBrand('retail')
  return NextResponse.json({ shipments })
}

// The real booking action: FoundRetail hands a shipment to FoundLogistics, exactly like handing a
