...
export default function SurveyPage() {
  ...
  useEffect(() => { document.title = 'Survey | FoundTalent' }, [])
  ...
  return (
    <section className="stack quantum-ambient-grid">
      <form className="fo-card fo-panel-glow" style={{ maxWidth: 560, margin: '60px auto', padding: 32, display: 'grid', gap: 18 }} onSubmit={onSubmit}>
        <header>
          <p style={{ margin: 0, opacity: 0.7, fontSize: 12, textTransform: 'uppercase', letterSpacing: '0.1em' }}>FoundTalent tester survey</p>
