...
export default async function IntelligencePage() {
  const layer = BRAND_PERSONALITIES.logistics
  const ai = generateBrandAIOutput('logistics')
  const quantum = await enrichBrandSignalWithQuantum(buildBrandSignal('logistics'))
  return (
    <BrandMicroDashboard
      brandSlug="logistics"
