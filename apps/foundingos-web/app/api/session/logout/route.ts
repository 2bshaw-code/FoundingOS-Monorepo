...
import { coreOperationsApiRoot, TENANT_REFRESH_COOKIE, TENANT_SESSION_COOKIE } from '../../../../src/tenant-session'
...
export async function POST(request: NextRequest) {
  ...
  if (refreshToken && apiRoot) {
    // Best-effort — revoke the refresh token server-side too, but never block sign-out on it.
