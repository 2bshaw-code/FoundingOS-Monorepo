  ...
  return (
    <>
      ...
      <AIInsightsPanel
        ...
        title="Cross-suite intelligence"
        sourceScope={['retail', 'logistics', 'finance', 'talent', 'health']}
      />
      <InsightsPanel apiBase={CORE_OPERATIONS_API_BASE} sourceScope={['retail', 'logistics', 'finance', 'talent', 'health']} />
    </>
  )
}
