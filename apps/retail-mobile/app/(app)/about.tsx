...
// copy as FoundingOS Quantum, framed for FoundRetail. Kept plain-text, no images/animation,
  ...
  return (
    <ScrollView style={styles.container} contentContainerStyle={{ padding: 16, gap: 14 }}>
      ...
      <View style={[styles.card, { borderColor: BRAND.accent }]}>
        ...
        <Text style={styles.cardText}>
          FoundRetail is designed around how message-based businesses actually operate — offline-friendly, mobile-first, and ready for teams anywhere in the world.
        </Text>
      </View>
      ...
      <View style={[styles.card, { borderColor: BRAND.accent }]}>
        ...
        <Text style={styles.cardText}>
          FoundAI handles onboarding, setup, training, workflows, tasks, and questions instantly — for FoundRetail and every other brand in FoundingOS.
        </Text>
      </View>
    </ScrollView>
  )
