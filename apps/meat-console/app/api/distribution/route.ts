...
// FoundMeat's real distribution/fulfillment view — every shipment this brand has ever booked
...
export async function GET(request: NextRequest) {
  ...
  const shipments = await listShipmentsForBrand('meat')
  return NextResponse.json({ shipments })
}

// The real booking action: FoundMeat hands a shipment to FoundLogistics, exactly like handing a
