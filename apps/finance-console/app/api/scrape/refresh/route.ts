...
const BRAND_NAME = 'FoundFinance'
const BRAND_SLUG = 'finance'
const CATEGORIES = ['invoices', 'payments', 'reconciliations'] as const
...
const PROFILE = {
  growthMultiplier: 1.6, // base new-engagement points per refresh
  anomalySpikeProbability: 0.06, // chance this refresh is a stochastic spike
  anomalySpikeMagnitude: 0.08, // extra anomalyScore added on a spike
  waveAmplitude: 0.2, // engagement-wave swing, as a fraction of growthMultiplier
  wavePeriodTicks: 14, // ticks (15-min windows) per full wave cycle
} as const
