...
const consoleLinks = [
  { name: 'Talent Manager Console', href: '/' },
  { name: 'Recruiter Console', href: '/recruiter' },
  { name: 'Applicant Console', href: '/applicant' },
  { name: 'Workforce Intelligence Console', href: '/intel' },
] as const
