...
const consoleLinks = [
  { name: 'Finance Intelligence & Reconciliation Console', href: `${brands.finance.consoleUrl.replace(/\/+$/, '')}/console` },
] as const

const cryptoHomeUrl = brands.finance.webUrl
const cryptoPackageUrl = (slug: string) => `${brands.finance.consoleUrl.replace(/\/+$/, '')}/console/packages/${slug}`
...
export default function Page() {
  ...
  const consoleDetails = [
    { name: 'Finance Intelligence & Reconciliation Console', href: `${brands.finance.consoleUrl.replace(/\/+$/, '')}/console`, description: 'Track cashflow, reconciliation, and reporting from one control surface.' },
  ] as const
      ...
      <section id="consoles" style={{ maxWidth: 1200, margin: '0 auto', padding: '24px 20px 24px' }}>
        <div style={{ border: '1px solid rgba(255,255,255,0.08)', borderRadius: 28, background: 'rgba(255,255,255,0.03)', padding: 28 }}>
          <div style={{ display: 'grid', gap: 10, marginBottom: 18 }}>
            ...
            <h3 style={{ margin: 0, fontSize: 'clamp(28px, 4vw, 42px)' }}>Purpose-built consoles for finance teams.</h3>
            <p style={{ margin: 0, maxWidth: 760, color: '#ddd6fe', lineHeight: 1.8 }}>Each console supports a distinct part of the finance workflow, from intelligence review to reconciliation support.</p>
          </div>
        ...
        {bobOpen && (
          <div onClick={() => setBobOpen(false)} style={{ position: 'fixed', inset: 0, background: 'rgba(1, 5, 10, 0.72)', display: 'grid', placeItems: 'center', padding: 20, zIndex: 60 }}>
            <div onClick={(event) => event.stopPropagation()} style={{ position: 'relative', width: 'min(440px, 92vw)', background: 'linear-gradient(180deg, rgba(15, 23, 42, 0.98), rgba(10, 15, 20, 0.98))', border: '1px solid rgba(255,255,255,0.1)', borderRadius: 28, boxShadow: '0 28px 80px rgba(0,0,0,0.45)', padding: 24, color: '#edf7ff' }}>
              ...
              <p style={{ margin: 0, color: '#bfd8ee', lineHeight: 1.7 }}>Bob AI helps your finance team track cashflow, reconciliation, and reporting so decisions stay sharp, fast, and well-informed.</p>
