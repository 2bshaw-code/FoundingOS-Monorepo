...
const legalSections = [
    ...
    { name: 'Privacy Policy', copy: 'We protect cashflow, invoicing, and contact data with strict controls and secure operational handling.' },
    { name: 'Terms & Conditions', copy: 'These terms govern account access, financial workflows, reconciliation support, and reporting-driven decision-making.' },
    ...
    { name: 'Compliance & Data Handling', copy: 'We apply governance to financial data, access controls, and reporting workflows to reduce operational risk.' },
    { name: 'Financial Risk Disclosure', copy: 'Financial decisions carry risk. Reports, alerts, and reconciliation guidance are informational and must be reviewed carefully.' }
] as const
