...
const BRAND_NAME = 'FoundTalent'
const BRAND_SLUG = 'talent'
const CATEGORIES = ['applications', 'interviews', 'placements'] as const
...
const PROFILE = {
  growthMultiplier: 2.2, // base new-engagement points per refresh
  anomalySpikeProbability: 0.1, // chance this refresh is a stochastic spike
  anomalySpikeMagnitude: 0.1, // extra anomalyScore added on a spike
  waveAmplitude: 0.35, // engagement-wave swing, as a fraction of growthMultiplier
  wavePeriodTicks: 10, // ticks (15-min windows) per full wave cycle
} as const
