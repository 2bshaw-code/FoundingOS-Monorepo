...
const BRAND_NAME = 'FoundThat'
const BRAND_SLUG = 'foundthat'
...
const PROFILE = {
  growthMultiplier: 1.5, // base new-engagement points per refresh
  anomalySpikeProbability: 0.05, // chance this refresh is a stochastic spike
  anomalySpikeMagnitude: 0.08, // extra anomalyScore added on a spike
  waveAmplitude: 0.15, // engagement-wave swing, as a fraction of growthMultiplier
  wavePeriodTicks: 12, // ticks (15-min windows) per full wave cycle
} as const
