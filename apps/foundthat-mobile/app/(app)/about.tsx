...
const SECTIONS = [
  ...
  },
  {
    ...
    text: 'FoundThat is designed around how message-based businesses actually operate \u2014 offline-friendly, mobile-first, and ready for teams anywhere in the world.',
  },
  {
    icon: '\u2726',
    label: 'Meet FoundAI',
    text: 'FoundAI handles onboarding, setup, training, workflows, tasks, and questions instantly \u2014 for FoundThat and every other brand in FoundingOS.',
  },
]

// Mirrors the web /about page (packages/ui/src/index.tsx) — same story/mission/how-we-work
// copy as FoundingOS Quantum, framed for FoundThat. Uses the same Quantum sphere + glow-card
  ...
  return (
    <ScrollView style={styles.container} contentContainerStyle={{ padding: 20, gap: 16 }}>
      <View style={styles.hero}>
        ...
        <Text style={styles.title}>About FoundThat</Text>
      ...
      <View style={[styles.taglineCard, { borderColor: BRAND.accent, shadowColor: BRAND.accent }]}>
        <Text style={styles.taglineText}>
          FoundThat is one of the connected brands inside FoundingOS. Discovery intelligence, on demand.
        </Text>
      </View>
