...
import { HomeIcon, CompassIcon, TagIcon, PulseIcon, SparkleIcon, LayersIcon } from '../../components/icons'
  ...
  return (
    <View style={{ flex: 1 }}>
      ...
      >
        ...
        <Tabs.Screen name="deals" options={{ title: 'Deals', headerTitle: 'Deals' }} />
