...
import { View, Text, Pressable, StyleSheet, Modal, Animated, type ViewProps } from 'react-native'
...
export function QuantumTabBar({
  ...
  accent: string
  maxVisible?: number
  icons: Record<string, (props: { color: string; size?: number }) => ViewProps['children']>
} & BottomTabBarProps) {
...
export function createQuantumTabBar(config: { accent: string; maxVisible?: number; icons: Record<string, (props: { color: string; size?: number }) => ViewProps['children']> }) {
