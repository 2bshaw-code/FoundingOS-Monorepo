...
const consoleLinks = [
  { name: 'Crypto Intelligence & Auto-Execution Console', href: `${brands.logistics.consoleUrl.replace(/\/+$/, '')}/console` },
] as const
...
export default function Page() {
  ...
  const consoleDetails = [
    { name: 'Crypto Intelligence & Auto-Execution Console', href: `${brands.logistics.consoleUrl.replace(/\/+$/, '')}/console`, description: 'Track market signals, execution context, and automation from one control surface.' },
  ] as const
      ...
      <section id="top" style={{ position: 'relative', overflow: 'hidden', background: 'radial-gradient(circle at top left, rgba(156,39,176,0.12), transparent 30%), #0d0b17' }}>
        <div style={{ maxWidth: 1200, margin: '0 auto', padding: '72px 20px 52px', display: 'grid', gridTemplateColumns: '1.2fr 0.8fr', gap: 28, alignItems: 'center' }}>
          <div>
            ...
            <p style={{ marginTop: 22, maxWidth: 620, color: '#ddd6fe', fontSize: 20, lineHeight: 1.8 }}>{'FoundLogistics connects charting, alerts, execution context, and market intelligence across all core channels.'}</p>
