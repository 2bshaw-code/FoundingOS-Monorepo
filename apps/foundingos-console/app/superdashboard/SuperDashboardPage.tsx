...
const BRAND_ROWS: BrandRow[] = [
  { brand: 'CoreOperations', marketing: 88, accounting: 96, serviceLoad: 42, previousServiceLoad: 39, messaging: 1240, aiActions: 68, status: 'good', marketingHistory: [80, 82, 85, 84, 87, 88] },
  { brand: 'IntelligenceAI', marketing: 91, accounting: 94, serviceLoad: 12, previousServiceLoad: 15, messaging: 860, aiActions: 214, status: 'good', marketingHistory: [86, 88, 89, 90, 90, 91] },
  { brand: 'CoreOperationsSocial', marketing: 84, accounting: 89, serviceLoad: 57, previousServiceLoad: 46, messaging: 2310, aiActions: 143, status: 'watch', marketingHistory: [92, 90, 88, 87, 85, 84] },
  { brand: 'CoreOperationsMarket', marketing: 79, accounting: 91, serviceLoad: 33, previousServiceLoad: 35, messaging: 980, aiActions: 76, status: 'good', marketingHistory: [75, 76, 78, 77, 79, 79] },
  { brand: 'CoreOperationsCloud', marketing: 72, accounting: 97, serviceLoad: 9, previousServiceLoad: 11, messaging: 410, aiActions: 58, status: 'good', marketingHistory: [70, 71, 70, 72, 71, 72] },
  { brand: 'CoreOperationsSecure', marketing: 68, accounting: 93, serviceLoad: 21, previousServiceLoad: 19, messaging: 305, aiActions: 39, status: 'watch', marketingHistory: [74, 73, 71, 70, 69, 68] },
  { brand: 'CoreOperations', marketing: 74, accounting: 99, serviceLoad: 14, previousServiceLoad: 14, messaging: 520, aiActions: 62, status: 'good', marketingHistory: [72, 73, 73, 74, 74, 74] },
  { brand: 'CoreOperations', marketing: 66, accounting: 92, serviceLoad: 48, previousServiceLoad: 37, messaging: 690, aiActions: 51, status: 'risk', marketingHistory: [70, 69, 68, 67, 66, 66] },
  { brand: 'CoreOperations', marketing: 81, accounting: 90, serviceLoad: 63, previousServiceLoad: 58, messaging: 770, aiActions: 88, status: 'watch', marketingHistory: [77, 78, 79, 80, 80, 81] },
]

const PREDICTIVE_INSIGHTS = [
  'CoreOperationsSocial marketing score trending -6% over 14 days — recommend creative refresh.',
  'CoreOperations service load projected to cross 70 tickets/day within 5 days.',
  'CoreOperations accounting health holding at 99% — no forecasted risk this quarter.',
]

const ANOMALIES = [
  { brand: 'CoreOperations', signal: 'Service load +31% week-over-week', tone: 'risk' as const },
  { brand: 'CoreOperationsSecure', signal: 'Marketing score below 70-day floor', tone: 'watch' as const },
]
...
const INITIAL_ACTION_QUEUE: ActionQueueItem[] = [
  { id: 'aq-1', description: 'Reassign 8 overdue CoreOperations tickets to standby queue', state: 'pending' },
  { id: 'aq-2', description: 'Scale IntelligenceAI messaging capacity +15% for weekend spike', state: 'pending' },
  { id: 'aq-3', description: 'Publish CoreOperationsSocial marketing recovery brief for brand lead review', state: 'pending' },
    ...
    <section className="stack">
      ...
      <div className="module-card-grid">
        <article className="module-card fo-card panel-premium">
          <div className="module-card-top"><span>01</span><strong>IntelligenceAI predictive insights</strong></div>
          <ul>
