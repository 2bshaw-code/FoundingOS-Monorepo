...
export const SURVEYS: Record<SurveyId, Survey> = {
  ...
  'survey-e': {
    ...
    questions: [
      { id: 'e1', prompt: "Did IntelligenceAI's suggested actions feel relevant to your brand?" },
      { id: 'e2', prompt: 'How much would you trust an autonomous AI action without manual review?' },
      { id: 'e3', prompt: "What's one task you'd want IntelligenceAI to fully automate?" },
