...
const BRAND_NAME = 'FoundHealth'
const BRAND_SLUG = 'health'
const CATEGORIES = ['appointments', 'records', 'claims'] as const
...
const PROFILE = {
  growthMultiplier: 2.0, // base new-engagement points per refresh
  anomalySpikeProbability: 0.08, // chance this refresh is a stochastic spike
  anomalySpikeMagnitude: 0.1, // extra anomalyScore added on a spike
  waveAmplitude: 0.3, // engagement-wave swing, as a fraction of growthMultiplier
  wavePeriodTicks: 9, // ticks (15-min windows) per full wave cycle
} as const
