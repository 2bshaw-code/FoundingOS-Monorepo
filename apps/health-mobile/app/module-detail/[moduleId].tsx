...
// (the exact metrics/actions/workflow already authored in brand-config.ts) from
// GET ${GROWTH_CONSOLE_URL}/api/console/modules/[moduleId], Bearer-authenticated.
export default function ModuleDetailScreen() {
  ...
  // Real, honest tap feedback -- these action labels (brand-config.ts) have no live CRUD
  // workflow behind them yet, so tapping confirms the action was noted rather than silently
