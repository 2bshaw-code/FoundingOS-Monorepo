...
// Pipeline, Team, Onboarding, About, Activity, Guardian) are pushed onto this
...
export default function AppStackLayout() {
  ...
  return (
    ...
    >
      ...
      <Stack.Screen name="superdash" options={{ headerShown: false }} />
      ...
      <Stack.Screen name="about" options={{ title: 'About FoundingOS' }} />
    </Stack>
  )
}
