...
export const WORKSPACE_OFFERS: Record<WorkspaceSlug, { offer: string; price: string; pitch: string }> = {
  ...
  talent: { offer: 'Talent bolt-on', price: '+£19/mo', pitch: 'Recruitment: jobs, candidates, interviews, offers and agency placements. Add HR too for £29 total.' },
  hr: { offer: 'HR bolt-on', price: '+£19/mo', pitch: 'Employees, contracts, rotas, timesheets, holiday, sickness and payroll inputs. Add Talent too for £29 total.' },
