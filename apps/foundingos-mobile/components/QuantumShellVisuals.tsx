...
import { Animated, Easing, StyleSheet, View, type StyleProp, type ViewProps, type ViewStyle } from 'react-native'
...
export function QuantumShellVisuals({ children }: { children?: ViewProps['children'] }) {
  return (
