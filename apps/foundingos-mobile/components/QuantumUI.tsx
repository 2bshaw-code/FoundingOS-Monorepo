...
export function QuantumSectionHeader({ label, action }: { label: string; action?: ViewProps['children'] }) {
  const theme = useActiveQuantumTheme()
  return (
...
export function QuantumFooter({ children }: { children: ViewProps['children'] }) {
  const theme = useActiveQuantumTheme()
  return <View style={[styles.footer, { borderTopColor: theme.borderColor }]}>{children}</View>
}

export function QuantumModalSurface({ children, style }: { children: ViewProps['children']; style?: StyleProp<ViewStyle> }) {
  const theme = useActiveQuantumTheme()
  return (
