...
const targets: Record<Network, { label: string; href: string }> = {
  instagram: { label: 'Instagram', href: 'https://instagram.com/wros' },
  linkedin: { label: 'LinkedIn', href: 'https://linkedin.com/company/wros' },
  tiktok: { label: 'TikTok', href: 'https://tiktok.com/@wros' },
  x: { label: 'X', href: 'https://x.com/wros' },
  facebook: { label: 'Facebook', href: 'https://facebook.com/wros' },
  youtube: { label: 'YouTube', href: 'https://youtube.com/@wros' },
  whatsapp: { label: 'WhatsApp', href: 'https://wa.me/00000000000' },
  telegram: { label: 'Telegram', href: 'https://t.me/wros' },
  messenger: { label: 'Messenger', href: 'https://m.me/wros' },
...
export function PremiumSocialLinks({
  ...
  return (
    <div style={style} aria-label={label ?? 'Social and messaging links'}>
      {label && mode !== 'inline' && (
