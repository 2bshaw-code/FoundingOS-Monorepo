...
export default function Page() {
  ...
  const consoleDetails = [
    ...
    { name: 'Data Operations Console', href: `${brands.it.consoleUrl.replace(/\/+$/, '')}/console`, description: 'Manage data workflows, reporting, and structured operations for the FoundIT brand.' },
  ] as const
    ...
    <main style={{ minHeight: '100vh', background: '#070c14', color: '#f8fafc', fontFamily: 'Inter, Segoe UI, sans-serif' }}>
      ...
      <section id="top" style={{ position: 'relative', overflow: 'hidden', background: 'radial-gradient(circle at top left, rgba(255,214,0,0.12), transparent 30%), #0b1321' }}>
        <div style={{ maxWidth: 1200, margin: '0 auto', padding: '72px 20px 52px', display: 'grid', gridTemplateColumns: '1.2fr 0.8fr', gap: 28, alignItems: 'center' }}>
          <div>
            <p style={{ margin: 0, color: '#fef3c7', fontSize: 12, letterSpacing: '0.18em', textTransform: 'uppercase', fontWeight: 800 }}>FoundIT brand ecosystem</p>
            ...
            <p style={{ marginTop: 22, maxWidth: 620, color: '#dfeaf8', fontSize: 20, lineHeight: 1.8 }}>{'FoundIT connects demand, opportunity, enquiry routing, and reporting across every market channel that matters.'}</p>
      ...
      <section id="contact" style={{ maxWidth: 1200, margin: '0 auto', padding: '24px 20px 12px' }}>
        <div style={{ border: '1px solid rgba(255,255,255,0.08)', borderRadius: 22, background: 'rgba(255,255,255,0.03)', padding: 22, display: 'grid', gap: 14 }}>
          ...
          <h3 style={{ margin: 0, fontSize: 'clamp(26px, 3.4vw, 38px)' }}>Connect with FoundIT on every channel.</h3>
        </div>
      </section>
      <footer style={{ borderTop: '1px solid rgba(255,255,255,0.08)', background: '#070c14', marginTop: 60 }}>
        <div style={{ maxWidth: 1200, margin: '0 auto', padding: '28px 20px 40px', display: 'flex', flexWrap: 'wrap', gap: 20, justifyContent: 'space-between', alignItems: 'flex-start' }}>
          ...
          <div style={{ display: 'grid', gap: 10, justifyItems: 'start' }}>
            <div style={{ color: '#dfeaf8' }}>hello@FoundIT.com</div>
            ...
            <div style={{ color: '#dfeaf8', fontSize: 14 }}>© 2026 FoundIT • All rights reserved</div>
          </div>
