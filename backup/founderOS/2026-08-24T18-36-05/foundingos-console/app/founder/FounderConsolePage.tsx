...
const translations = {
  en: {
    title: 'FounderOS master control centre',
  ...
  es: {
    title: 'Centro de control maestro de FounderOS',
  ...
  fr: {
    title: 'Centre de contrôle principal de FounderOS',
...
const sections: ControlSection[] = [
  ...
  { key: 'permissions', title: 'All permissions', summary: 'Role scopes, approvals, and access policy controls for the FounderOS stack.', amount: 36, status: 'Live' },
    ...
    <section className="stack">
      ...
      <div className="module-card-grid">
        {sections.map((section, index) => {
          ...
          return (
          <article key={section.key} className="module-card">
