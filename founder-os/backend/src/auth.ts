...
// Meat/crypto roles retained in the shared roles enum for backward
// compatibility but excluded from active ecosystem access — see
// /docs/deprecations.md.
export const ecosystemRoles = [roles.founderMaster, roles.retailManager, roles.retailStaff, roles.itIntelligence, roles.itDataOps, roles.talentManager, roles.recruiter, roles.applicant, roles.workforceIntel]
...
const ensureDefaultTalentUser = async () => {
  const email = 'talent.manager@core_workforce.io'
