...
const brandCards = [
  { label: 'Core.Operations', href: 'http://localhost:5210', brand: 'core_operations', accent: '#25D366', title: 'Customers, Orders & Commerce' },
  { label: 'Core.Intelligence', href: 'http://localhost:5230', brand: 'foundthis', accent: '#FFD600', title: 'KPIs, Funnels & Reporting' },
  { label: 'Core.Workforce', href: 'http://localhost:5240', brand: 'core_workforce', accent: '#F97316', title: 'Talent Acquisition' },
] as const

const featureCards = [
  { icon: '◉', title: 'Unified Dashboard', text: 'Manage every suite from a single, intuitive interface.' },
  { icon: '◌', title: 'Cross-Suite Insights', text: 'Track performance across Core.Operations, Core.Workforce, and Core.Intelligence in real time.' },
  { icon: '◍', title: 'Automated Workflows', text: 'Streamline operations with powerful automation tools.' },
] as const

const partnerNames = ['NextMart', 'PrimeSavory', 'TalentHive'] as const
      ...
      <section className="hero-section">
        ...
        <div className="hero-content">
          <div className="hero-copy">
            ...
            <p>One platform, three suites: Core.Operations, Core.Workforce, Core.Intelligence.</p>
            ...
            <div className="dashboard-frame">
              ...
              <div className="dashboard-surface">
                ...
                <div className="brand-pills">
                  ...
                  <span className="pill meat">Core.Intelligence</span>
                  <span className="pill crypto">Core.Workforce</span>
                </div>
              </div>
            </div>
          </div>
      ...
      <section className="ecosystem-band" aria-labelledby="meet-bob-ai">
        <BobIntroCard
          ...
          paragraphs={[
            ...
            'FoundingOS gives every user — from operators to recruiters and intelligence teams to founders — one universal guide who knows exactly what they need.',
  ...
  return (
    <CorporateLayout title="About" intro="FoundingOS is the operating layer for founder-led businesses building coordinated, scalable portfolios.">
      <div className="info-card wide-card">
        <p>We help founders structure a premium operating stack across operations, workforce, and intelligence — giving each suite dedicated depth while unifying oversight, decision-making, automation, and analytics.</p>
      </div>
    </CorporateLayout>
  )
}
