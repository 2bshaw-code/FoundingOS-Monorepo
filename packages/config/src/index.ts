...
*/
// NOTE: This legacy per-brand registry is superseded by the suite registry
// in `./suites.ts` (Core.Operations / Core.Workforce / Core.Intelligence).
// Legacy slugs remain only for migration compatibility. Do not add new
// brand slugs here; extend `./suites.ts` instead.
...
export const brands: Record<BrandSlug, BrandDefinition> = {
  ...
  retail: {
    slug: 'retail',
    name: 'CoreOperations',
    legalName: 'CoreOperations',
    marketingName: 'CoreOperations',
    tagline: 'Retail operations, connected.',
    description: 'CoreOperations helps growing businesses guide product discovery, support customers, and manage messaging-first retail workflows with more clarity and less manual effort.',
    accent: '#00C853',
    ...
    logo: '◉',
    typography: { heading: 'Inter', body: 'Inter' },
    socialHandle: 'core_operations',
    modules: ['Customers', 'Inventory', 'Orders', 'Products'],
    summary: 'Retail operations for catalogues, customers, orders, and teams.',
  },
  // DEPRECATED: FoundMeat has been removed from the active FoundingOS product.
  // Entry retained only so historical BrandSlug lookups do not throw; do not
  // surface this brand in any UI, routing, or navigation. See docs/deprecations.md.
  meat: {
    slug: 'meat',
    name: 'FoundMeat (deprecated)',
    legalName: 'FoundMeat (deprecated)',
    marketingName: 'FoundMeat (deprecated)',
  ...
  it: {
    slug: 'it',
    name: 'CoreIntelligence',
    legalName: 'CoreIntelligence',
    marketingName: 'CoreIntelligence',
    ...
    logo: '✦',
    typography: { heading: 'Inter', body: 'Inter' },
    socialHandle: 'core_intelligence',
  ...
  talent: {
    slug: 'talent',
    name: 'CoreWorkforce',
    legalName: 'CoreWorkforce',
    marketingName: 'CoreWorkforce',
    ...
    logo: '⬢',
    typography: { heading: 'Inter', body: 'Inter' },
    socialHandle: 'core_workforce',
    modules: ['Applicants', 'Recruiters', 'Jobs', 'Workforce Intel'],
    summary: 'Hiring analytics and workforce intelligence for modern teams.',
  },
  // DEPRECATED: FoundCrypto has been removed from the active FoundingOS product.
  // Entry retained only so historical BrandSlug lookups do not throw; do not
  // surface this brand in any UI, routing, or navigation. See docs/deprecations.md.
  crypto: {
    slug: 'crypto',
    name: 'FoundCrypto (deprecated)',
    legalName: 'FoundCrypto (deprecated)',
    marketingName: 'FoundCrypto (deprecated)',
