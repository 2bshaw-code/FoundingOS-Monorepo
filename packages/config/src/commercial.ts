...
export const commercialPlans: Record<PlanTier, CommercialPlan> = {
  ...
  starter: {
    ...
    includedSeats: 3,
    includedSuites: ['core_operations'],
    includedWorkspaces: ['Core.Operations: sales, orders, inventory, and customers', 'Basic finance', 'Marketing and Brand Studio'],
  ...
  growth: {
    ...
    includedWorkspaces: ['Core.Operations', 'Core.Workforce', 'Core.Intelligence'],
