...
const TUTORIALS: Array<{ id: string; title: string; description: string; steps: string[]; image: string; why: string; helps: string; does: string }> = [
  ...
  },
  {
    ...
    image: '/demo/screens/brandwheel.webp',
  ...
  },
  {
    ...
    image: '/demo/screens/carshop.webp',
  ...
  },
  {
    ...
    image: '/demo/screens/journey.webp',
  ...
  },
  {
    ...
    image: '/demo/screens/foundingos-demo.webp',
  ...
  },
  {
    ...
    image: '/demo/screens/tutorials.webp',
  ...
  },
  {
    ...
    image: '/demo/screens/talent-demo.webp',
  ...
  },
  {
    ...
    image: '/demo/screens/brand-demos.webp',
  ...
  {
    id: 'meat-traceability',
    title: 'FoundMeat batch traceability',
    description: 'Run compliance-ready batch tracking and temperature logging for butchers, suppliers, and distributors.',
    steps: ['Open FoundMeat from the main menu.', 'Select Batch Tracking.', 'Review batch status and temperature logs.', 'Generate a compliance report.', 'Export or share the report.'],
    image: '/demo/screens/meat-demo.webp',
    why: 'Food safety regulators and buyers demand provable batch-level traceability, not spreadsheets.',
    helps: 'It keeps temperature logs, batch history, and compliance reports one tap away.',
    does: 'FoundingOS turns FoundMeat into an audit-ready traceability system by default.',
  },
  {
    id: 'talent-pipeline',
    title: 'FoundTalent hiring pipeline',
    description: 'Move candidates from application to interview with one connected pipeline.',
    steps: ['Open FoundTalent from the main menu.', 'Select Candidates.', 'Review candidate profile.', 'Move candidate to next pipeline stage.', 'Schedule an interview.'],
    image: '/demo/screens/talent-demo.webp',
    why: 'Recruiters lose great candidates to slow, scattered hiring workflows.',
    helps: 'It keeps every candidate, stage, and interview in one clear pipeline view.',
    does: 'FoundingOS gives FoundTalent teams a fast, intelligent path from application to offer.',
  },
  {
    id: 'foundthat-marketplace',
    title: 'FoundThat marketplace listings',
    description: 'Publish listings and track buyer engagement inside the FoundThat marketplace.',
    steps: ['Open FoundThat from the main menu.', 'Click Create Listing.', 'Add product details and images.', 'Publish listing.', 'Review buyer engagement metrics.'],
    image: '/demo/screens/foundthat-demo.webp',
    why: 'Marketplace sellers need listings live fast, with real engagement data feeding back.',
    helps: 'It streamlines listing creation and surfaces buyer engagement in one place.',
    does: 'FoundingOS makes FoundThat a fast, discovery-led marketplace engine.',
  },
  {
    id: 'crypto-portfolio',
    title: 'FoundCrypto portfolio tracking',
    description: 'Track balances, transactions, and market trends for crypto traders and businesses.',
    steps: ['Open FoundCrypto from the main menu.', 'View your portfolio balance.', 'Review recent transactions.', 'Check market trends.', 'Generate a performance summary.'],
    image: '/demo/screens/crypto-demo.webp',
    why: 'Crypto traders need clear, trustworthy portfolio and compliance visibility.',
    helps: 'It combines balances, transaction history, and market trends into one summary.',
    does: 'FoundingOS keeps FoundCrypto simple, transparent, and audit-ready.',
  },
  {
    id: 'finance-cashflow',
    title: 'FoundFinance invoices & cashflow',
    description: 'Manage invoices, payment status, and cashflow forecasts with one financial summary.',
    steps: ['Open FoundFinance from the main menu.', 'Review outstanding invoices.', 'Check payment statuses.', 'View cashflow forecast.', 'Generate monthly financial summary.'],
    image: '/demo/screens/finance-demo.webp',
    why: 'Businesses lose money and time when invoices and cashflow live in separate tools.',
    helps: 'It gives finance teams one connected view of invoices, payments, and forecasts.',
    does: 'FoundingOS keeps FoundFinance clear, automated, and always current.',
  },
  {
    id: 'health-care-workflow',
    title: 'FoundHealth patient & care workflow',
    description: 'Manage patient records, appointments, and care workflows for clinics and health providers.',
    steps: ['Open FoundHealth from the main menu.', 'Select Patients.', 'Review patient details.', 'Schedule an appointment.', 'Update care workflow.'],
    image: '/demo/screens/health-demo.webp',
    why: 'Care teams need patient records and scheduling in one safe, connected place.',
    helps: 'It keeps patient details, appointments, and care updates moving without friction.',
    does: 'FoundingOS gives FoundHealth teams a clear, compliant care workflow.',
  },
  {
    id: 'logistics-routing',
    title: 'FoundLogistics shipments & routing',
    description: 'Track shipments, review routes, and monitor fleet performance in one view.',
    steps: ['Open FoundLogistics from the main menu.', 'Review active shipments.', 'View route map.', 'Check fleet performance.', 'Generate delivery summary.'],
    image: '/demo/screens/logistics-demo.webp',
    why: 'Logistics teams need live shipment and fleet visibility to hit delivery targets.',
    helps: 'It surfaces active shipments, routes, and fleet performance at a glance.',
    does: 'FoundingOS keeps FoundLogistics fast, visible, and delivery-ready.',
  },
]
