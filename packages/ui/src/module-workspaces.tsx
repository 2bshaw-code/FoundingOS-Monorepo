...
const layouts: Record<string, WorkspaceLayout> = {
  ...
  'finance/approvals': 'queue', 'talent/time-off': 'queue', 'talent/onboarding': 'queue',
  ...
  'retail/payments': 'ledger', 'retail/purchasing': 'ledger', 'logistics/billing': 'ledger', 'logistics/quotes': 'ledger', 'health/billing': 'ledger', 'health/claims': 'ledger', 'talent/payroll': 'ledger',
...
const sampleText: Record<string, string[]> = {
  ...
  'talent/onboarding': ['Mei Chen|Right to work, contract, uniform|Day 1', 'Amara Okafor|Food hygiene course, till training|Week 1', 'Lucas Silva|Licence check, van induction|Day 1', 'Grace Obi|Bank details, pension opt-in|Week 2'],
  'talent/people': ['Tom Hale|Store manager · Harbour St|Full-time', 'Priya Anand|Head baker · Central kitchen|Full-time', 'Sofia Martins|Barista · Harbour St|Part-time', 'Kofi Mensah|Driver · Logistics|Full-time', 'Grace Obi|Bookkeeper · Office|Part-time', 'Amina Yusuf|Operations lead · Office|Full-time'],
  'talent/performance': ['Tom Hale|Q1 review · store targets|92', 'Priya Anand|Q1 review · waste reduction|88', 'Sofia Martins|Q1 review · customer score|81', 'Kofi Mensah|Q1 review · on-time delivery|76'],
  'talent/time-off': ['Sofia Martins|Annual leave · 3 days · 14–16 May|3 days', 'Kofi Mensah|Sick leave · 1 day|1 day', 'Tom Hale|Annual leave · 1 week · June|5 days', 'Priya Anand|Training day|1 day'],
  'talent/learning': ['Food hygiene level 2|Required · 4 staff|4 enrolled', 'Allergen awareness|Required · 6 staff|6 enrolled', 'Till & refunds|Onboarding|2 enrolled', 'First aid at work|Optional|1 enrolled'],
  'talent/payroll': ['March payroll|12 staff · monthly|£11,420.00', 'March overtime|4 staff|£640.00', 'Holiday pay adjustment|2 staff|£310.00', 'April payroll|12 staff · monthly|£11,580.00'],
  'talent/engagement': ['Pulse survey April|Response rate 83%|7.9', 'Harbour St team|Store team score|8.2', 'Central kitchen|Kitchen team score|7.1', 'Drivers|Logistics team score|6.8'],
