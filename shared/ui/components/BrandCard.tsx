...
const brandLabels: Record<BrandSlug, string> = {
  ...
  foundmeat: 'FoundMeat (deprecated)',
  foundthis: 'Intelligence',
  core_intelligence: 'Intelligence',
  core_workforce: 'CoreWorkforce',
  foundcrypto: 'FoundCrypto (deprecated)',
}

const brandAccents: Record<BrandSlug, string> = {
  'founding-os': founderOsTheme.primary,
  'founder-os': founderOsTheme.primary,
  core_operations: '#25D366',
  foundmeat: '#B00020',
  foundthis: '#FFD600',
  core_intelligence: '#FFD600',
  core_workforce: '#F97316',
  foundcrypto: '#7C3AED',
}
