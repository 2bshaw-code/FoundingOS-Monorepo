...
export const brandTheme = {
  ...
  core_operations: { ...founderOsTheme, primary: '#4ade80', secondary: '#1f2937', accent: '#4ade80', surface: '#0d1724' },
  foundthis: { ...founderOsTheme, primary: '#facc15', secondary: '#fef3c7', accent: '#facc15', surface: '#17130a' },
  core_intelligence: { ...founderOsTheme, primary: '#facc15', secondary: '#fef3c7', accent: '#facc15', surface: '#17130a' },
  core_workforce: { ...founderOsTheme, primary: '#fb923c', secondary: '#fdba74', accent: '#fb923c', surface: '#1b120d' },
} as const