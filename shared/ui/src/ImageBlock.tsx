...
import core_operationsDashboard from '../../images/stock/core_operations-dashboard.svg'
import core_intelligenceDashboard from '../../images/stock/core_intelligence-dashboard.svg'
import core_workforceDashboard from '../../images/stock/core_workforce-dashboard.svg'

type ImageVariant = 'founder-hero' | 'founder-dashboard' | 'core_operations-dashboard' | 'core_intelligence-dashboard' | 'core_workforce-dashboard'

const images: Record<ImageVariant, string> = {
  'founder-hero': founderHero,
  'founder-dashboard': founderDashboard,
  'core_operations-dashboard': core_operationsDashboard,
  'core_intelligence-dashboard': core_intelligenceDashboard,
  'core_workforce-dashboard': core_workforceDashboard,
}
